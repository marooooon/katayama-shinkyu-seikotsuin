...
このプロジェクトは、React（Next.js）を使用してマークダウン形式の.md ファイルを読み込み、ブログサイトを構築するものです。以下に実装方法を示します。
    ...
    <header className="bg-gray-800 text-white p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav>
          ...
          <ul
            className={`${menuOpen ? 'block' : 'hidden'} lg:flex lg:space-x-4`}
          >
            <li>
              <Link href="/">
                <a className="hover:text-gray-400">TOP</a>
